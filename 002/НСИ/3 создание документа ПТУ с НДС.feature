...
Функционал: создание документа ПТУ с НДС

Как тестировщикя хочу
создать документ ПТУ
чтобы использовать его при дальнейших проверках в отчетах

Контекст:
	Дано я запускаю сценарий открытия TestClient или подключаю уже существующий
	И я закрываю все окна клиентского приложения

Сценарий: я создаю новый документ ПТУ с НДС, контрагент- ТестКА1, организация - ООО Тест, товар-ТоварНДС20
* загружаю тестовые данные
	Когда я создаю новую организацию  приминением общей системы налогообложения (в т.ч. с НДС)
	И я создаю нового контрагента ТестКА1  и ТестКА2
	И я создаю новый товар с НДС 20 
...
* проверка заполнения данных СФ
	...
	И элемент формы с именем "Организация" стал равен '$ТестООО$'
