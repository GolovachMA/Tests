...
Функционал: создание документа возврата поставщику на эталонной базе

Как тестировщик я хочу
создать документ возврата поставщику
чтобы использовать его в отчете сверка взаиморасчетов  

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий
	И я закрываю все окна клиентского приложения

Сценарий: я создаю документ возврата поставщику 
...
* проверка создания документа возврата
	И в таблице "СписокДокументыЗакупки" я перехожу к строке:
		...
		| '$НомерВозврата$' | 'ТестКА1'    | 'Тест ООО'    |
